...
```
apt install wget -y; bash <(wget -qO- https://github.com/DaNovaNet/Swit-DaNova-Mod/raw/main/install/ubuinst.sh)
```
</br>
...
```
apt install wget -y; bash <(wget -qO- https://github.com/DaNovaNet/Swit-DaNova-Mod/raw/main/install/sincpainel.sh)
```
